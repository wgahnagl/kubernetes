...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1beta1.PodPriorityShutdownGracePeriod)(nil), (*config.PodPriorityShutdownGracePeriod)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_PodPriorityShutdownGracePeriod_To_config_PodPriorityShutdownGracePeriod(a.(*v1beta1.PodPriorityShutdownGracePeriod), b.(*config.PodPriorityShutdownGracePeriod), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.PodPriorityShutdownGracePeriod)(nil), (*v1beta1.PodPriorityShutdownGracePeriod)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_PodPriorityShutdownGracePeriod_To_v1beta1_PodPriorityShutdownGracePeriod(a.(*config.PodPriorityShutdownGracePeriod), b.(*v1beta1.PodPriorityShutdownGracePeriod), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_KubeletConfiguration_To_config_KubeletConfiguration(in *v1beta1.KubeletConfiguration, out *config.KubeletConfiguration, s conversion.Scope) error {
	...
	out.PodPriorityShutdownGracePeriods = *(*[]config.PodPriorityShutdownGracePeriod)(unsafe.Pointer(&in.PodPriorityShutdownGracePeriods))
...
func autoConvert_config_KubeletConfiguration_To_v1beta1_KubeletConfiguration(in *config.KubeletConfiguration, out *v1beta1.KubeletConfiguration, s conversion.Scope) error {
	...
	out.ShutdownGracePeriod = in.ShutdownGracePeriod
	out.ShutdownGracePeriodCriticalPods = in.ShutdownGracePeriodCriticalPods
	out.PodPriorityShutdownGracePeriods = *(*[]v1beta1.PodPriorityShutdownGracePeriod)(unsafe.Pointer(&in.PodPriorityShutdownGracePeriods))
...
func autoConvert_v1beta1_PodPriorityShutdownGracePeriod_To_config_PodPriorityShutdownGracePeriod(in *v1beta1.PodPriorityShutdownGracePeriod, out *config.PodPriorityShutdownGracePeriod, s conversion.Scope) error {
	out.Priority = in.Priority
	out.ShutdownGracePeriodSeconds = in.ShutdownGracePeriodSeconds
	return nil
}

// Convert_v1beta1_PodPriorityShutdownGracePeriod_To_config_PodPriorityShutdownGracePeriod is an autogenerated conversion function.
func Convert_v1beta1_PodPriorityShutdownGracePeriod_To_config_PodPriorityShutdownGracePeriod(in *v1beta1.PodPriorityShutdownGracePeriod, out *config.PodPriorityShutdownGracePeriod, s conversion.Scope) error {
	return autoConvert_v1beta1_PodPriorityShutdownGracePeriod_To_config_PodPriorityShutdownGracePeriod(in, out, s)
}

func autoConvert_config_PodPriorityShutdownGracePeriod_To_v1beta1_PodPriorityShutdownGracePeriod(in *config.PodPriorityShutdownGracePeriod, out *v1beta1.PodPriorityShutdownGracePeriod, s conversion.Scope) error {
	out.Priority = in.Priority
	out.ShutdownGracePeriodSeconds = in.ShutdownGracePeriodSeconds
	return nil
}

// Convert_config_PodPriorityShutdownGracePeriod_To_v1beta1_PodPriorityShutdownGracePeriod is an autogenerated conversion function.
func Convert_config_PodPriorityShutdownGracePeriod_To_v1beta1_PodPriorityShutdownGracePeriod(in *config.PodPriorityShutdownGracePeriod, out *v1beta1.PodPriorityShutdownGracePeriod, s conversion.Scope) error {
	return autoConvert_config_PodPriorityShutdownGracePeriod_To_v1beta1_PodPriorityShutdownGracePeriod(in, out, s)
}
